...
#include "../infra/threadpool/threadpool.h"
...
public:
    ...
    void init(int port , string user, string passWord, string databaseName,
              ...
              int mysql_idle_timeout, int upload_max_bytes, long user_storage_quota_bytes, int conn_timeout,
...
public:
    ...
    long m_user_storage_quota_bytes;
